# Ports of checkpoint-ai

The same scan logic, ported across languages so you can drop checkpoint-ai into any stack
or ship a single static binary. All ports share the rule IDs and JSON output shape.

| Language | Path | Run |
|---|---|---|
| Python (reference) | `../checkpoint_ai/` | `checkpoint-ai scan .` |
