"""Native cognis-connect emit for checkpoint-ai — forward findings to any platform.

Maps checkpoint-ai's JSON output to the canonical `Finding` and forwards it via
...
Usage:
    checkpoint-ai ... --format json | checkpoint-ai-emit --to stix
    checkpoint-ai-emit --to slack --url $WEBHOOK --dry-run < findings.json
"""
