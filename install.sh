#!/usr/bin/env sh
# Universal installer for checkpoint-ai. Prefers uv > pipx > pip; installs from the repo.
set -e
SRC="git+https://github.com/cognis-digital/checkpoint-ai.git"
echo "Installing checkpoint-ai ..."
...
echo "Done. Run: checkpoint-ai --help"
